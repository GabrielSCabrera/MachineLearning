...
def gauss_seidel_iterator(A, b, k, x0 = None, seed = None):
    """
    ...
    if A.ndim != 2 or A.shape[0] != A.shape[1]:
        raise ValueError(gauss_seidel_iterator.__doc__)
    ...
    # Initializing Matrices L, D, and U
    L = np.tril(A, k = -1)
...
if __name__ == "__main__":
    ...
    k = 10
    seed = 1
    x = gauss_seidel_iterator(A, b, k, seed = seed)
